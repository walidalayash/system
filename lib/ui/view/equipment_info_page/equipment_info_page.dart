...
class EquipmentInfokPage extends StatefulWidget {
  const EquipmentInfokPage({super.key});

  @override
  State<EquipmentInfokPage> createState() => _EquipmentInfokPageState();
}

class _EquipmentInfokPageState extends State<EquipmentInfokPage> {
  var _isInit = true;
  ...
  Widget card(context, type) {
    List<Equipment> equipmentPost =
        Provider.of<EquipmentPost>(context, listen: false).equipmentPost;
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
    return Wrap(
      children: List.generate(equipmentPost.length, (index) {
        return equipmentPost[index].state == type
            ? InkWell(
                child: Stack(
                  children: [
                    Column(
                    ...
                    Column(
                      children: [
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(equipmentPost[index].userName,
                        ...
                        Padding(
                          ...
                          child: Text(
                            equipmentPost[index].typeEquipment,
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                              fontFamily: 'Karla',
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                              width: 100,
                              height: 100,
                              child: Image.network(equipmentPost[index].photo)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(
                            left: 150,
                          ),
                          child: Text(equipmentPost[index].timeRequest,
                              style: const TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                                  fontFamily: 'Karla2')),
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return DetalisPage(
                        userName: equipmentPost[index].userName,
                        department: equipmentPost[index].department,
                        description: equipmentPost[index].timeRequest,
                        something: equipmentPost[index].typeEquipment,
                        photo: equipmentPost[index].photo,
                        quantity: equipmentPost[index].typeRequest,
                        state: equipmentPost[index].state);
                  }));
                },
              )
            : Container();
